...
<div class="contain">
    <div class="form-utiliser">
        ...
        <form action="<?=BASE_URL?>/article-vente/setup/add" method="POST">
            <div class="ligne">
        ...
        <?php if (Session::isset("utilisers")):?>
            <div class="nouveau btnligne" style="">
                <a href="<?=BASE_URL?>/article-vente/setup/abort" class="btnSave btnAnnuler">Annuler</a>
                <a href="<?=BASE_URL?>/article-vente/form" class="btnSave">Créer Article</a>
            </div>
        <?php endif ?>
    </div>
</div>