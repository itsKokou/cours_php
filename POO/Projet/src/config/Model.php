...
class Model {
   ...
   */
   ...
   public function findByPaginate(int $offset, int $nbreParPage){
      $sql = "select * from $this->table limit $offset,$nbreParPage";
      return $this->executeSelect($sql);
   }

   public function countElement():int{
      $sql = "select count(*) as nbre from $this->table";
      return $this->executeSelect($sql,[],true)->nbre; // retourne directement la clé nombre créée
   }
