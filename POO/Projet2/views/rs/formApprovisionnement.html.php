...
<div class="contain">
    <div class="form-utiliser">
        ...
        <form action="<?=BASE_URL?>/approvisionnement/add" method="POST">
            <div class="ligne">
        ...
        <?php if(Session::isset("approvisionners")): ?>
            ...
            <div class="observation">
                <form action="<?=BASE_URL?>/approvisionnement/create" method="POST">
                    <div class="ligne ob">
                    ...
                    <div class="ligne btn">
                        <a href="<?=BASE_URL?>/approvisionnement/abort" class="btnSave btnAnnuler">Annuler</a>
