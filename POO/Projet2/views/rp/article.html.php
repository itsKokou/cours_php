...
<div class="nouveau" style="">
    <a href="<?=BASE_URL?>/article-vente/setup" class="btnSave">Nouveau</a>
</div>
<div class="conteneur">
    <div class="form form2">
        <form action="<?=BASE_URL?>/article-vente" method="post">
        ...
        <table>
            ...
            ?>
                <tr>
                    ...
                    <td><a href="<?=BASE_URL?>/article-vente/detail?article=<?=$art->getId()?>">Voir</a></td>
                </tr>
            <?php endforeach ?>
        </table>
